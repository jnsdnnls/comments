...
<div id="comments" class="mt-8 space-y-4">
    ...
    <div class="relative p-4 shadow-sm pl-16">
        <img src="{{ Statamic::modify($comment['email'])->gravatar() }}" alt="User Logo" class="absolute top-4 left-4 w-8 h-8 bg-green-500 rounded-full">

        <div class="flex items-centertext-xs gap-2">
            <h2 class="text-white font-bold">{{ $comment['email'] }}</h2>
